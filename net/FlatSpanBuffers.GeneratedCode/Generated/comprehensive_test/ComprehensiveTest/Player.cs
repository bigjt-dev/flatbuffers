...
public struct Player : IFlatbufferObject
{
  ...
  public static void AddInventoryType(FlatBufferBuilder builder, VectorOffset inventoryTypeOffset) { builder.AddOffset(6, inventoryTypeOffset); }
  ...
  public static void AddSkills(FlatBufferBuilder builder, VectorOffset skillsOffset) { builder.AddOffset(8, skillsOffset); }
  ...
  public static void AddStats(FlatBufferBuilder builder, VectorOffset statsOffset) { builder.AddOffset(9, statsOffset); }
  ...
  public static void AddEquippedType(FlatBufferBuilder builder, int equippedTypeOffset) { builder.AddOffset(13, equippedTypeOffset); }
  ...
  public static void AddEquippedItem(FlatBufferBuilder builder, int equippedItemOffset) { builder.AddOffset(15, equippedItemOffset); }

...
const static FlatCOption flatc_options[] = {
    ...
    {"", "version", "", "Print the version number of flatspan and exit."},
...
std::string FlatCompiler::GetUsageString(
  ...
  std::string files_description =
      ...
      "directory or the path given by -o.\n\n"
      "example: " +
      program_name + " -o out/ schema1.fbs schema2.fbs";
